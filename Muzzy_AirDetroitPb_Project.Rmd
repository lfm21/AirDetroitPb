...
Pb1981to2018.gathered <- rbind(Pb1981, Pb1982, Pb1983, Pb1984, Pb1985,
  ...
  select(Pb1981to2018.gathered, Date, Site.ID, Site.Name,
...
Pb1981to2018.points <- list.files("./EPA_Pb_data_Processed/Pb1981to2018.points.csv", full.names = TRUE)

Pb1981to2018.points <- read.csv("./EPA_Pb_data_Processed/Pb1981to2018_points.csv")

PbDetroit <- head(Pb1981to2018.points)
head(Pb1981to2018.points)
...
```{r 5.2 child risk graph , echo=FALSE}
