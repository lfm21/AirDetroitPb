...
Tidy up dataset: select only useful columns, convert coordinates into geometry, format to Date.
```{r class, echo=TRUE}
library(dplyr) 
...
###Most of the wrangling was done earlier in order to show a tidy usable dataset for the table. But there are examples of the wrangling in the datasets below.
